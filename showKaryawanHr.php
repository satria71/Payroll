...
<div class="container">
    <h3>Data Karyawan Harian Lepas</h3>
<hr>
...
<?php 
    $sql = "select nik, nama, jabatan, alamat, notelp
            ...
            where tb_karyawan.kode_jabatan = tb_jabatan.kode_jabatan and status = 0";
...
<tr>
    ...
    <?php
        $nip = $data["nik"];
        echo "<a href='proses/deleteKaryawan.php?id=$nip' class='btn btn-primary'>Detail</a>";
    ?>
    </td>
</tr>
